package com.example.firstprototype.cssq
...
class EasyCss : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionsList = Constants.getQuestionsForCss()
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            val intent =
                                Intent(this@EasyCss, result::class.java)
